...
def train_model(model, dataloader, max_epochs=10,limit_train_batches=None, checkpoint_dir=None,save_best = False):
...
def main():
    ...
    train_model(kernel_model, dataloader,max_epochs=10, limit_train_batches = 100,checkpoint_dir=None)
